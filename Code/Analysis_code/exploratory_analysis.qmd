...
```{r, Ad~Cs1}
```
From this set of images it looks like the starkest difference between the two penguin species is represented by Culmen length. I should be able to test this against the other variables by running a principal components analysis. I omit Body Mass as a variable because I am more interested in shape based data at the moment.
