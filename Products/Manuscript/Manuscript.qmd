...
#| echo: FALSE
knitr::include_graphics("../../Results/Figures/Dimorphism/cor_plots.png")
```



```{r}
#| label: penguins_MassV
#| fig-cap: "Species Body Mass Distribution"
#| echo: FALSE
knitr::include_graphics("../../Results/Figures/Dimorphism/penguins_MassV.png")
```

```{r}
#| label: Dimorphism_violin
#| fig-cap: "Body Mass Dimorphism~Species"
#| echo: FALSE
knitr::include_graphics("../../Results/Figures/Dimorphism/Dimorphism_violin.png")
```
