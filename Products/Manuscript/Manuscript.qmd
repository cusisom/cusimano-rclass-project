...
The data collected from the LTER was produced by Dr. Kristen Gorman and made accessible by Andrea Shandel via the Palmer Penguins dataset (github.com/andreashandel/dataanalysis-template).
...
#| echo: FALSE
resulttable=readRDS("../../Results/Adelie_Dimorphism_ttest.rds")
```
```{r}
#| label: tbl-Gentoo_ttest
#| tbl-cap: "Gentoo Sexual Dimorphism T-test"
#| echo: FALSE
resulttable=readRDS("../../Results/Gentoo_Dimorphism_ttest.rds")
```
```{r}
#| label: tbl-Chinstrap_ttest
#| tbl-cap: "Chinstrap Sexual Dimorphism T-test"
#| echo: FALSE
resulttable=readRDS("../../Results/Chinstrap_Dimorphism_ttest.rds")
```
